  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'light-foreground-4': themes.light.baseColors.foreground4,
        ...
        'light-background-4': themes.light.baseColors.background4,
        ...
        'dark-foreground-4': themes.dark.baseColors.foreground4,
        ...
        'dark-background-4': themes.dark.baseColors.background4,
  ...
  plugins: [
    ...
    function ({ addComponents }: { addComponents: Function }) {
      addComponents({
        ...
        ...genereateTailwindThemeClasses(
          'border-background-3',
          'border-light-background-3',
          'border-dark-background-3',
        ),

        ...genereateTailwindThemeClasses('bg-foreground-4', 'bg-light-foreground-4', 'bg-dark-foreground-4'),
        ...genereateTailwindThemeClasses('bg-background-4', 'bg-light-background-4', 'bg-dark-background-4'),
        ...genereateTailwindThemeClasses('text-foreground-4', 'text-light-foreground-4', 'text-dark-foreground-4'),
        ...genereateTailwindThemeClasses('text-background-4', 'text-light-background-4', 'text-dark-background-4'),
        ...genereateTailwindThemeClasses(
          'border-background-4',
          'border-light-background-4',
          'border-dark-background-4',
        ),
        ...genereateTailwindThemeClasses(
          'border-foreground-4',
          'border-light-foreground-4',
          'border-dark-foreground-4',
        ),
      });
    },
  ],
